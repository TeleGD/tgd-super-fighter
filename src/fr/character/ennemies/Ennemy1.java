...
public class Ennemy1 extends Ennemy implements Rectangle {
	...
	public Ennemy1(int x, int y, double stretch, double xorigine, double yorigine) {
		...
		this.arrived = false;
		try {
			this.imagecentrale = new Image("Images/Images ennemis/ennemi1imgcentrale.png");
			this.imagegauchePD = new Image("Images/Images ennemis/ennemy1gauchePD.png");
			this.imagegauchePG = new Image("Images/Images ennemis/ennemy1gauchePG.png");
			this.imagegauchestop = new Image("Images/Images ennemis/ennemy1gauchestop.png");
			this.imagedroitePD = new Image("Images/Images ennemis/ennemy1droitePD.png");
			this.imagedroitePG = new Image("Images/Images ennemis/ennemy1droitePG.png");
			this.imagedroitestop = new Image("Images/Images ennemis/ennemy1droitestop.png");
